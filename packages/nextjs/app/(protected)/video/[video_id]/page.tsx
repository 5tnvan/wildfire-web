...
const Video: NextPage = () => {
  ...
  // const fetchPlaybackInfo = async (playback_id: string) => {
  //   try {
  //     const info = await livepeerClient.playback.get(playback_id);
    ...
    if (video && video.playback_id) {
      (async () => {
        try {
          ...
          //fetchPlaybackInfo(video.playback_id);
          setPlaybackInfo("error");
        }
        handleIncrementViews();

        // Add a thumbnail to the metadata
        ...
        //           hrn: "Thumbnail (JPEG)",
        //           type: "image/jpeg",
        //           url: "https://wildfire.b-cdn.net/30e68e4b-7e19-43be-b890-0592e3e1ec38/1733077557510.jpg",
        //         },
        //       ],
        //     },
        //   };

        // Update the state with VOD source including the thumbnail
        //   setVodSourceWithThumb(vodSourceWithThumbnail);
      })();
    }
  }, [video]);
